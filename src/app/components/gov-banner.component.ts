        ...
        <header class="usa-banner__header">
          <div class="usa-banner__inner" data-testid="banner-header-inner-div">
            <div class="grid-col-auto" data-testid="banner-header-flag-div">
              <img class="usa-banner__header-flag" alt="" src="/media/gov-banner-flag.png" aria-hidden="true">
            </div>
        ...
        <div class="usa-banner__content usa-accordion__content" id="gov-banner" hidden="">
          <div class="grid-row grid-gap-lg">
            <div class="usa-banner__guidance tablet:grid-col-6">
              <img class="usa-banner__icon usa-media-block__img" src="/media/gov-banner-building.svg" alt="" aria-hidden="true">
              <div class="usa-media-block__body">
                <p><strong>Official websites use .gov</strong><br>A <strong>.gov</strong> website belongs to an official government organization in the United States.</p>
              </div>
            </div>
            <div class="usa-banner__guidance tablet:grid-col-6">
              <img class="usa-banner__icon usa-media-block__img" src="/media/gov-banner-lock.svg" alt="" aria-hidden="true">
